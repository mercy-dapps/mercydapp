    ...
    <div className="flex flex-col gap-16">
      ...
      <main className="container">
        <section>
          ...
          <p className="mb-6">
            Hi there, I am Mercy! A frontend developer and a solana smart
            contract developer with interest in security researching. I am
            currently building EasyHaven - a decentralized property management.
          </p>
          <p className="mb-6">
            With background in Computer science and over 4 years building
            scalable and efficient web applications, I have gained professional
            experience building production ready applications. Over the period
            of 4 years as a frontend developer, I have built applications across
            fintech, ecommerce and healthcare management system.
          </p>
          <p className="mb-6">
          ...
          <p className="mb-6">
            ...
            <span className="highlight-text">SuperteamNG</span>, solana
            bootcamps at <span className="highlight-text">Turbine</span> and
            recently started documenting my challenges and project on{" "}
          ...
          <div className="flex flex-col gap-8">
            <div className="flex flex-col gap-4">
              ...
              <div className="subtitle">
                I wrote about my approach in resolving an rpc issue after days
                of debugging with no clue before coming across the same issue on
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="subtitle">
                Code refactor does not end right? We keep optimizing our
                codebase either by adding new feature or refactoring existing
                codebase. In this article, I refactored some of the existing
                code after finding better ways of doing things.
              </div>
            </div>
            <div className="flex flex-col gap-4">
              <h5 className="title">
              ...
              <div className="subtitle">
                Building in public is something I want to do and this project
                seem a good way to start. I decided to work on a decentralized
                property managment platform after having faced some challenges
                which decentralization helps solve irrespective of the location.
              </div>
            </div>
            <div className="flex flex-col gap-4">
              <h5 className="title">
              ...
              <div className="flex flex-col gap-8">
                <div className="flex flex-col gap-4">
                  ...
                  <ul className="list-inside list-disc flex flex-col gap-4">
                    <li>
                      Resposible for building production ready web user
                      interfaces
                    </li>
                    <li>
                      Logic implementation ensuring better user experience
                    </li>
                    <li>
